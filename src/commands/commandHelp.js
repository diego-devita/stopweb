    ...
    const comandi = {
        ...
        'fetch': {
            ...
            esempi: [
                ...
                { uso: 'fetch --dataInizio 20230101 --dataFine 20240101', descrizione: 'Intervallo da-a (YYYYMMDD)'},
                { uso: 'fetch --dataInizio 20230101', descrizione: 'Intervallo da-a oggi (YYYYMMDD)'},
